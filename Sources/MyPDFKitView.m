...
- (void) initializeDisplay
{
  ...
  [self setBackgroundColor:PreviewBackgroundColor];
...
- (void) notificationSetup;
{
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self
                                           selector:@selector(previewBackgroundColorChange:)
                                               name:PreviewBackgroundColorChangedNotification object:nil];
    /*
    [[NSNotificationCenter defaultCenter] addObserver:self
...
- (void)previewBackgroundColorChange: (NSNotification *)notification
{
  [self setBackgroundColor:PreviewBackgroundColor];
}
